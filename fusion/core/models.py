...
class Funcionalidade(Base):
    ...
    SIDE_CHOICES = (
        ('fadeInRight', _('Direita')),
        ('fadeInLeft', _('Esquerda')),
    )

    funcionalidade = models.CharField(_('Funcionalidade'), max_length=50)
    descricao = models.TextField(_('Descrição'), max_length=80)
    icone = models.CharField(_('Icone'), max_length=16, choices=ICONE_CHOICES)
    lado = models.CharField(_('Lado'), max_length=11, choices=SIDE_CHOICES)
